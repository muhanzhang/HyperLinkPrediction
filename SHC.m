function [Lambda,scores] = SHC(hltrain,hltest,num_prediction)
%  Spectral Hypergraph Clustering, from paper "Learning with hypergraphs: Clustering, classification, and embedding"
